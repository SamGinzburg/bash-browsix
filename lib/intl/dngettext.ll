; ModuleID = 'dngettext.c'
source_filename = "dngettext.c"
target datalayout = "e-p:32:32-i64:64-v128:32:128-n32-S128"
target triple = "asmjs-unknown-emscripten"

; Function Attrs: noinline nounwind
define i8* @libintl_dngettext(i8* %domainname, i8* %msgid1, i8* %msgid2, i32 %n) #0 {
entry:
  ...
  %call = call i8* @libintl_dcngettext(i8* %0, i8* %1, i8* %2, i32 %3, i32 5)
  ret i8* %call
}
