; ModuleID = 'dcgettext.c'
source_filename = "dcgettext.c"
target datalayout = "e-p:32:32-i64:64-v128:32:128-n32-S128"
target triple = "asmjs-unknown-emscripten"

; Function Attrs: noinline nounwind
define i8* @libintl_dcgettext(i8* %domainname, i8* %msgid, i32 %category) #0 {
entry:
  ...
  %call = call i8* @libintl_dcigettext(i8* %0, i8* %1, i8* null, i32 0, i32 0, i32 %2)
  ret i8* %call
}
