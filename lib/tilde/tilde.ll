...
@default_prefixes = internal global [3 x i8*] [i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* null], align 4
@tilde_additional_prefixes = global i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @default_prefixes, i32 0, i32 0), align 4
@default_suffixes = internal global [3 x i8*] [i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0), i8* null], align 4
@tilde_additional_suffixes = global i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @default_suffixes, i32 0, i32 0), align 4
@.str = private unnamed_addr constant [8 x i8] c"tilde.c\00", align 1
...
if.then:                                          ; preds = %entry
  ...
  %call2 = call i8* @sh_xmalloc(i32 %add, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 200)
...
if.else:                                          ; preds = %entry
  ...
  %call5 = call i8* @sh_xmalloc(i32 %add4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 202)
...
if.then9:                                         ; preds = %while.body
  ...
  %call13 = call i8* @sh_xrealloc(i8* %7, i32 %add12, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 216)
...
if.end22:                                         ; preds = %land.lhs.true, %if.end14
  ...
  %call24 = call i8* @sh_xmalloc(i32 %add23, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 233)
...
if.else30:                                        ; preds = %if.end22
  ...
  call void @sh_xfree(i8* %32, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 243)
  br label %if.end31
...
if.then36:                                        ; preds = %if.end31
  ...
  %call40 = call i8* @sh_xrealloc(i8* %37, i32 %add39, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 253)
...
if.end41:                                         ; preds = %if.then36, %if.end31
  ...
  call void @sh_xfree(i8* %45, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 258)
  br label %while.body
...
if.then3:                                         ; preds = %if.end
  ...
  %add = add i32 1, %call
  %call4 = call i8* @sh_xmalloc(i32 %add, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 358)
...
if.then14:                                        ; preds = %lor.lhs.false, %if.end6
  %call15 = call i8* @sh_get_env_value(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0))
...
if.then27:                                        ; preds = %if.then24
  ...
  call void @sh_xfree(i8* %20, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 388)
  %21 = load i8*, i8** %expansion, align 4
  call void @sh_xfree(i8* %21, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 389)
...
if.then38:                                        ; preds = %if.then35
  ...
  call void @sh_xfree(i8* %31, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 412)
  br label %if.end40
...
if.then44:                                        ; preds = %if.end41
  ...
  %call47 = call i8* @sh_xmalloc(i32 %add46, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 418)
...
if.end51:                                         ; preds = %if.else, %if.end49
  ...
  call void @sh_xfree(i8* %39, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 425)
  call void @endpwent()
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call4 = call i8* @sh_xmalloc(i32 %add3, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 336)
...
entry:
  ...
  %call1 = call i8* @sh_xmalloc(i32 %call, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32 277)
