; ModuleID = 'mbscmp.c'
source_filename = "mbscmp.c"
target datalayout = "e-p:32:32-i64:64-v128:32:128-n32-S128"
target triple = "asmjs-unknown-emscripten"

; Function Attrs: noinline nounwind
define i32 @mbscmp(i8* %mbs1, i8* %mbs2) #0 {
entry:
...
if.end40:                                         ; preds = %if.end39
  ...
  %29 = load i8*, i8** %mbs1.addr, align 4
  %add.ptr = getelementptr inbounds i8, i8* %29, i32 %28
  store i8* %add.ptr, i8** %mbs1.addr, align 4
  %30 = load i32, i32* %len2, align 4
  %31 = load i8*, i8** %mbs2.addr, align 4
  %add.ptr41 = getelementptr inbounds i8, i8* %31, i32 %30
  store i8* %add.ptr41, i8** %mbs2.addr, align 4
  br label %do.cond
